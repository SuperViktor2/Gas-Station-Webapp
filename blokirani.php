...
<html lang="hr">
    ...
    <body id="body">
      ...
      <div class="container">
        <div class="trazi">
            <form name="pretraga" id="pretrazi" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    
                <input name="submit" class="gumb" type="submit" value="Odblokiraj" />
                <input class="txtBox" name="korime" type="search" placeholder="Korisničko ime" /><br>
            </form>
        </div>
        ...
        <div class="info">
            <?php
                ...
                print "
                    <table id='tablica' style='width: 80%;'>
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Korisnik</th>
                ...
                while ($red = $odg->fetch_assoc()) {
                    ...
                    print "<td>" . $red['email'] . "</td>";
                    print "<td>BLOKIARN</td>";
                    print "</tr>";
                }
