...
<html lang="hr">
    ...
    <body id="body">
      ...
      <div class="container">
        <p class="upute">Dodavanje/Ažuriranje lokacija</p>
        ...
        <div class="info">
            <?php
                ...
                $id = $_GET['id'];
                $opcija = $_GET['opcija'];
                $lokacija = ucwords($_GET['lokacija']);
                ...
                if (isset($_GET['submit'])) {
                    if ($opcija == 'upload') {
                        $upload = "INSERT INTO Lokacija (naziv) VALUES (
                            '$lokacija'
                        )";
                        $veza->updateDB($upload);
                        header( "refresh:1;url=lokacije.php" );
                    } 
                    elseif ($opcija == 'azuriraj') {
                        $update = "UPDATE Lokacija SET naziv = '$lokacija' WHERE idLokacija = '$id'";
        ...
        <div class="forma">
            ...
            <form name="lokacije" id="forma" method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div id="azuriranje">
                    <label for="id">ID Lokacije</label>
                    <input id="id" class="txtBox" name="id" type="number" placeholder="Unesite ID Lokacije"/><br>
                </div>
